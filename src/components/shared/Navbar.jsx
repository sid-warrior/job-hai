    ...
    <div className="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b shadow-sm">
      <div className="flex items-center justify-between mx-auto max-w-7xl h-[4.5rem] px-4 sm:px-6 lg:px-8">
        <div className="relative group">
          <Link to="/">
            <h1 className="text-2xl sm:text-3xl font-bold  tracking-tight bg-gradient-to-r from-[#4E992E] to-[#000] bg-clip-text text-transparent">
              Job
              <span className="bg-gradient-to-r from-[#0000] to-[#0000] bg-clip-text text-transparent">
                Hai
              </span>
            </h1>
          </Link>
